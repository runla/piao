package com.yinghai.piaowan.animation;
 ...
 *         Created Time: 2018/4/19 14:21
 *         Describe：View的属性动画基础类
 */

public class ViewPropertyAnim extends Animation {
    ...
    public ViewPropertyAnim fading(@FloatRange(from=0.0f,to=1.0f) float fromAlpha, @FloatRange(from=0.0f,to=1.0f) float toAlpha) {
